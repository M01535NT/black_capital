        ...
        <div className="space-y-6 max-w-5xl mx-auto w-full">
            ...
            <div className="flex items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h2 className="text-2xl font-display font-bold text-foreground truncate max-w-xl">
                            {property.title}
                        </h2>
                ...
                <div className="flex gap-2">
                    <Link href={`/inventario/${property.id}`} target="_blank">
                    ...
                    <div className="bg-card border border-foreground/10 rounded-2xl p-5">
                        ...
                        <div className="space-y-2 text-sm">
                            <div className="flex justify-between">
                                ...
                                <span className="text-foreground/70 font-mono text-xs">{property.id.slice(0, 8)}...</span>
                            </div>
                            <div className="flex justify-between">
