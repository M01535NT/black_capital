        ...
        <div className="w-full flex-1 bg-background">
                    ...
                    <div className="lg:col-span-5">
                        <div className="border border-white/10 bg-background/82 p-4 shadow-2xl shadow-black/40 backdrop-blur-xl">
                            <div className="flex items-center gap-3 border-b border-white/[0.08] pb-4">
                                ...
                                <div>
                                    <p className="text-sm font-semibold text-white">Respuesta comercial</p>
                                    <p className="text-xs text-white/50">Formulario y WhatsApp disponibles</p>
                                </div>
                            </div>
                            <div className="grid gap-3 py-4">
                                {["Tipo de activo", "Zona de interés", "Presupuesto", "Datos de contacto"].map((label) => (
                                    <div key={label} className="flex items-center justify-between border border-white/[0.08] bg-white/[0.03] px-4 py-3">
                                        ...
                                        <span className="text-xs uppercase tracking-[0.14em] text-[var(--color-accent)]">Enviar</span>
                                    </div>
                                ))}
                            </div>
                            <Link
                ...
                <div className="grid grid-cols-1 gap-5 md:grid-cols-2" role="list">
                    {contactCards.map((card, i) => {
                        ...
                        return (
                            ...
                            >
                                <span className="mb-5 block text-[10px] font-semibold uppercase tracking-[0.2em] text-white/40">
                                ...
                                <div className="mb-6 min-h-12 space-y-1">
                                    {card.lines.map((line, idx) => (
                                        <p key={idx} className="text-sm leading-6 text-white/64">
                                            {line}
                                        </p>
                                    ))}
                                </div>
                                {card.action && (
                                    <a
                                        ...
                                        className="inline-flex min-h-10 items-center justify-center gap-2 rounded-full border border-[var(--color-accent)]/35 px-5 text-[11px] font-bold uppercase tracking-[0.14em] text-[var(--color-accent)] transition-colors hover:bg-[var(--color-accent)] hover:text-black"
                                    >
            ...
            <section id="agendar" aria-label="Agendar" className="mx-auto max-w-[90rem] px-6 py-16 text-center sm:px-10 lg:px-16 lg:py-24">
                <div className="mx-auto max-w-2xl">
                    ...
                    <h2 className="mb-5 text-display-2 font-light leading-display tracking-headline text-white">
                        Continúa por inventario o WhatsApp.
                    </h2>
                    <p className="mb-10 text-sm leading-7 text-white/58">
