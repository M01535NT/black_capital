...
const FALLBACK: PropertyCardData[] = [
  {
    ...
    m2_terrain: 420,
    m2_construction: 320,
    cover_image: "/line-residencial.webp",
    status: "Available",
  ...
  },
  {
    ...
    m2_terrain: 210,
    m2_construction: 210,
    cover_image: "/line-comercial.webp",
    status: "Available",
  ...
  },
  {
    ...
    cover_image: "/line-industrial.webp",
    status: "Available",
...
export async function FeaturedInventory() {
  ...
  return (
    <section className="border-t border-white/[0.08] bg-white/[0.015]">
      <div className="mx-auto max-w-[90rem] px-6 py-16 sm:px-10 lg:px-16 lg:py-24">
        <Reveal className="mb-10 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div className="max-w-xl">
            ...
            <p className="mt-4 text-body leading-snug text-white/58">
              Verificadas y listas para visitar.
            </p>
          </div>
          <div className="flex items-center gap-6">
            <span className="hidden items-center gap-2 property-tag-type text-white/35 sm:inline-flex">
      ...
      <div className="mx-auto max-w-[90rem] px-6 pb-16 sm:px-10 lg:px-16 lg:pb-24">
        <FeaturedTrack properties={list.slice(0, 8)} />
      </div>
    </section>
  );
}
