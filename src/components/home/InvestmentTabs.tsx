...
const LINEAS: Linea[] = [
  {
    ...
    name: "Black Luxury",
    href: "/black-luxury",
    description: "Residencias en fraccionamientos privados con seguridad 24/7, amenidades y ubicación premium.",
    longDescription:
      "Selección de casas residenciales en las mejores zonas de Tijuana. Cada propiedad incluye análisis de plusvalía, due diligence legal y acompañamiento en todo el proceso de compra.",
    highlights: [
