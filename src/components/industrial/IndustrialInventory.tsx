                ...
                {loading ? (
                    ...
                    <FadeIn className="max-w-2xl mx-auto text-center py-16">
                        <div className="border border-steel-500/15 bg-zinc-950/50 p-12">
                            ...
                            <h3 className="text-xl font-display font-bold text-foreground/70 mb-3 uppercase tracking-wider">
                            ...
                            <StaggerItem key={prop.id}>
                                ...
                                >
                                    ...
                                    <div className="p-6 space-y-3">
                                        <h3 className="text-lg font-display font-bold text-foreground group-hover:text-gold-500 transition-colors">
                                            {prop.title}
                                        </h3>
