...
export function LuxuryCTA() {
            ...
            const { error } = await supabase.from("leads").insert([
                {
                    ...
                    status: "new",
                    notes: data.company
                        ? `Luxury Landing — Empresa/Fondo: ${data.company}`
                        : "Luxury Landing",
                },
            ]);
    ...
    return (
        <section id="luxury-cta" className="w-full py-28 bg-background relative overflow-hidden">
            {/* Decorative borders */}
                        ...
                        {!isSuccess ? (
                            <div className="flex flex-col md:flex-row gap-14 relative z-10">
                                ...
                                <div className="flex-1 space-y-6">
                                    ...
                                    <p className="text-white/45 text-base max-w-md leading-relaxed">
                                        Portafolio reservado con propiedades Off-Market, análisis
                                        financiero personalizado, y acompañamiento fiduciario para
                                        inversiones de alto patrimonio.
                                    </p>
                            ...
                            <div className="relative z-10 py-16 flex flex-col items-center justify-center text-center space-y-4">
                                ...
                                <h3 className="text-2xl font-bold text-white">
                                    ¡Bienvenido al Directorio Exclusivo!
                                </h3>
                                <p className="text-white/50 max-w-md">
                                    Tu solicitud ha sido registrada. Nuestro equipo de relaciones
                                    con inversores se pondrá en contacto contigo en las próximas
                                    24 horas para brindarte acceso personalizado.
                                </p>
                            </div>
                        )}
                    </div>
