        ...
        <section className="relative w-full min-h-[95vh] flex flex-col items-center justify-center overflow-hidden">
            ...
            <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-12">
                <div className="max-w-5xl space-y-10">
                    ...
                    >
                        Residencias trofeo, penthouses de autor y desarrollos exclusivos
                        seleccionados para inversores HNWI con los estándares más exigentes
                        del mercado inmobiliario mexicano.
                    </motion.p>
