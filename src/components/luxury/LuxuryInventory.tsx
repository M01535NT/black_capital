...
export function LuxuryInventory() {
            ...
            <div className="container mx-auto px-4">
                <FadeIn className="text-center max-w-3xl mx-auto mb-20">
                    ...
                    <h2 className="section-heading text-3xl md:text-5xl text-foreground mb-4">
                        Propiedades de{" "}
                        <span className="metallic-gold">Súper Lujo</span>
                    </h2>
                    <p className="text-foreground/45 text-lg">
                        Cada propiedad ha sido verificada, analizada financieramente
                        y aprobada por nuestro comité de inversiones.
                    </p>
                </FadeIn>
                    ...
                    <FadeIn className="max-w-2xl mx-auto text-center py-16">
                        <div className="rounded-2xl border border-gold-500/10 bg-zinc-950/40 backdrop-blur-sm p-12">
                            ...
                            <p className="text-foreground/40 text-sm max-w-md mx-auto">
                                Nuestro equipo está seleccionando las mejores propiedades de lujo.
                                Solicita acceso anticipado para ser el primero en conocerlas.
                            </p>
                        </div>
                    </FadeIn>
                ) : (
                ...
                <FadeIn className="text-center mt-16">
                    <Link href="/inventario?brand=luxury">
                        <Button
                            variant="outline"
