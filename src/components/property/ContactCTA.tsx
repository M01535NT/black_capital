    ...
    return (
        <div className="relative overflow-hidden border border-white/[0.08] bg-white/[0.025] p-5">
            <div className="relative z-10 space-y-4">
                <h3 className="property-tag-type text-white/48">
                    ¿Te interesa?
                </h3>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                    className="brushed-gold flex w-full items-center justify-center gap-2 rounded-full py-3 premium-cta transition-all duration-300 hover:brightness-105"
                >
                    <MessageCircle className="size-4" />
