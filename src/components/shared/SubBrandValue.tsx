                        ...
                        >
                            ...
                            <div className="space-y-5 p-5">
                                ...
                                <Link
                                    ...
                                    className="inline-flex w-full items-center justify-center gap-2 border border-[var(--color-gold-light)]/45 px-4 py-2.5 premium-cta hover:bg-[var(--color-gold-light)] hover:text-black"
                                >
                                    Inventario
