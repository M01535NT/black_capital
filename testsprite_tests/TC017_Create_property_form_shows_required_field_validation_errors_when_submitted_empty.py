...
async def run_test():
    ...
    try:
        ...
        # -> Click on 'Add new property' button to open property creation form (button index 831).
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div[2]/div/main/div/div[1]/a/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        
        # -> Click the submit button ('Guardar Propiedad') to trigger inline validation messages for required fields.
        frame = context.pages[-1]
        # Click element
